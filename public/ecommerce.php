...
<head>
   ...
   .dropdown-content{display: none;
    ...
    input[type=text]
    {padding:10px; font-size: 20px;border: 1px solid grey;width: 40%;}
    input[type=password]
    {padding:10px; font-size: 20px;border: 1px solid grey;width: 40%;}
    .modal {
  display: none; 
...
<form class="modal-content animate" action="elogin.php" method="post" ><center>
...
<div class="card">
  ...
  <p><button id="don1">Add to Cart</button></p></div></td>
  <td>
<div class="card">
  ...
  <p>G17 Gaming...........................................</p>
  <p><button id="don2">Add to Cart</button></p></div></td>
  <td>
<div class="card">
